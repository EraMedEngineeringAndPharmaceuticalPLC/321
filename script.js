...
const alwaysVisible = ['nav', 'contact'];
const homeExtras = ['about', 'locations'];

// All section IDs that might be shown at any point
const allSections = [
    // Always visible
    'nav', 'contact',
    ...
    // About
    'company-overview', 'timeline-section1', 'mission-values', 'team', 'recognition',

    // Products & Services
    'products', 'all-products', 'manufacturing', 'clients-partners', 'partners-clients',
    ...
    // Resources
    'resources', 'news-blog', 'vacancy', 'value-content', 'quote',

    // Contact sub-sections
    'appointment', 'faq',

    // Sister Companies (external links – don't need IDs unless they are sections)
    'sister-companies'
];
...
function showSection(sectionId) {
    allSections.forEach(id => {
        ...
        if (alwaysVisible.includes(id)) {
            ...
            // Home-specific additional sections
        } else if (sectionId === 'home' && homeExtras.includes(id)) {
            el.style.display = 'block';
